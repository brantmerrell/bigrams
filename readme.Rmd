...
### Issues to Fix or Discuss
 * _Logs versus raw counts_  
 * _Probability density versus frequency_  
 * _Alphabetized bins versus other methods of aggregation_
 * __Add numeric values above bars__
 * __Increase font size for x axes__
