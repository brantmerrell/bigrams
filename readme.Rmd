...
### Executability
An R shiny application is available at [https://brantmerrell.shinyapps.io/programming_exercise/](https://brantmerrell.shinyapps.io/programming_exercise/), which allows users to manually upload one txt file at a time and view the resulting histogram of bigrams. This application can also be run locally by calling runApp() in the R console from the *Programming Exercise* directory provided with this submission.  
